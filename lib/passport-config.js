...
module.exports = function(passport) {
  ...
  'https://afternoon-reaches-90413.herokuapp.com/auth/facebook/callback' :
  'http://localhost:3000/auth/facebook/callback';
  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : Process.env.FBID ||'181425716138709',
    clientSecret : Process.env.FB_SECRET ||'637f7538883aa4438ce87ec5b20d1e22',
